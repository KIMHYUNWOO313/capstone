...
보안·용량 제한으로 `.gitignore` 처리:

- `.env`, `*.pem`, Firebase credentials
- 100MB 초과 학습 데이터 (`train_data.csv` 등)
- `data/mofe_daily/html/`, `*.pkl` 등 대용량 원본

로컬 개발·배포 시 위 파일은 별도로 준비해야 합니다.

## 라이선스

Capstone 프로젝트 — 교육·연구 목적
